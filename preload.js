...
window.appAPI = {
  ...
  // 일봉 데이터 + 지표 계산 (Input-based paging: from/to 날짜 범위)
  ...
  // AI 채팅 스트리밍 (ipcMain.on + event.reply 방식)
  // images: [{ base64, mediaType }] — 이미지 첨부 시 전달
  ...
  // 박스권 스캐너 — configOverride: localStorage에서 읽은 사용자 설정값
